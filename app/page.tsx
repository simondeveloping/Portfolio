    ...
    <div>
      ...
      <div className="w-full flex lg:flex-row justify-between h-auto mb-20 flex-col">
        <div className="w-full lg:w-1/2 flex justify-center items-center flex-col gap-1 lg:gap-5 p-10">
          ...
          <p>
            This section shows the distribution of browsers used by visitors in
            2025. By understanding which browsers are most popular, I can ensure
            the website runs smoothly across all platforms. It&apos;s valuable
            insight for improving user experience and optimizing performance.
          </p>
        </div>
